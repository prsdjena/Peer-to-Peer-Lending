...
<body>
    ...
    <div id="page" style="background: whitesmoke;">

        <div id="main-content">
            <div id="myHeader">
                <button style="color: white;border-radius: 15px;font-size: 52px; background: black;font-weight: bolder;margin-bottom: 50px;">Transaction Details</button>
            </div>
            <div id="main-options">
                <div id="modal">
                    <div class="question">
                            ...
                            <div class="a bottom">
                                ...
                                ?>
                                    <div class="options" style="color:black;">
                                        ...
                                        <div class="project-details" style="color: black;">
                                            <h3 style="color:black;"><?php echo $rows['title']; ?></h3>
                                                <p>Project category: <?php echo $rows['category']; ?></p>
                                                <h4 style="color:grey;" >Project Description</h4>

                                                <p ><?php echo $rows['descrip']; ?></p>
                                                <h4 style="color:grey;">Amount Needed: <span class="amount">Rs. <?php echo ($rows['amount'] - $rows['collect']); ?></span></h4>
                                                <h4 style="color:grey;"> Days Left: <span class="days"><?php echo $rows['timee']; ?></span></h4>

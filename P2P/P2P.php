...
<body style="background-image: url(img/back.jpeg); background-repeat: no-repeat; background-size: cover; position: sticky;">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class=" col-md-9 col-lg-9 ">
                                        ...
                                        <input type="submit" name="Invest" class="btn btn-primary">
